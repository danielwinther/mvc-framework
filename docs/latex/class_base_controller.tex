...
Referenced by Basic\textbackslash{}index(), and Basic\textbackslash{}return\+Model().
...
14             \textcolor{comment}{//throw new ModelNotFound('ModelNotFound', 'Model "' . $model . '" not found.');}
15             \textcolor{comment}{//exit();}
16         \}
17 
