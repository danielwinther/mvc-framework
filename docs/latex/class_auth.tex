...
41 
42         $client = \textcolor{keyword}{new} Client(\hyperlink{config_8php_a9b6aafbdebd605cd4fb6f5749b53e59f}{TWILIO\_SID}, \hyperlink{config_8php_a0477d5c66524299f08cae7376eb7884c}{TWILIO\_TOKEN});
43         $client->messages->create(
44             \textcolor{stringliteral}{'+45'} . $user->phone,
45             array(
46                 \textcolor{stringliteral}{'from'} => \textcolor{stringliteral}{'+46769447755'},
47                 \textcolor{stringliteral}{'body'} => $user->twoFactorCode
48                 )
49             );
50     \}
\end{DoxyCode}
...
Referenced by Basic\textbackslash{}index(), send\+Two\+Factor(), and verify\+Two\+Factor().
...
\begin{DoxyCode}
55                                                   \{
56         $user = \hyperlink{class_auth_a7949f68385a98a60ff42ea3c3a768ec7}{Auth::user}();
57 
58         \textcolor{keywordflow}{if} ($user->twoFactorCode == $code) \{
59             $user->isTwoFactor = \textcolor{keyword}{true};
60             $user->save();
61         \}
62     \}
\end{DoxyCode}
