...
\begin{DoxyCode}
21                                   \{
22         $config = \hyperlink{config_8php_afeb1d281d402615776fdb0320a5b8d05}{initializeConfig}();
23         $this->controller = $config[\textcolor{stringliteral}{'defaultController'}];
24         $this->method = $config[\textcolor{stringliteral}{'defaultMethod'}];
25         $this->parameter = $config[\textcolor{stringliteral}{'defaultParameters'}];
26 
27         $this->load($this->parseUrl());
28     \}
\end{DoxyCode}
