...
References \$controller, database\+Config(), and initialize\+Config().
...
26         $database = \hyperlink{database_8php_a87165585cf80e6b4d470b694f7dea4d3}{databaseConfig}();
27         $this->databaseConnection($database[\textcolor{stringliteral}{'hostname'}], $database[\textcolor{stringliteral}{'databaseName'}], $database[\textcolor{stringliteral}{'charset'}], 
      $database[\textcolor{stringliteral}{'username'}], $database[\textcolor{stringliteral}{'password'}]);
28     \}
\end{DoxyCode}
